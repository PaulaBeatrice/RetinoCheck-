...
df_train = pd.read_csv(r'D:\FACULTATE\FACULTATE\LICENTA\proiect\data\APTOS\train_1.csv')
df_train.head()
...
for i, image_id in enumerate(tqdm(df_train['id_code'])):
    image = cv2.imread(
        f'D:/FACULTATE/FACULTATE/LICENTA/proiect/data/APTOS/train_images/train_images/{image_id}.png')
...
RLROP_PATIENCE = 3
DECAY_DROP = 0.5
DETAILS = "without augmentation and filters"
VERSION="12"
