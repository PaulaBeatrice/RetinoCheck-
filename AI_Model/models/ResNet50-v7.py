...
for i, image_id in enumerate(tqdm(df_train['id_code'])):
    image = cv2.imread(
        f'D:/FACULTATE/FACULTATE/LICENTA/proiect/data/APTOS/train_images/train_images_apply_clahe_gaussian_filter/{image_id}.png')
...
RLROP_PATIENCE = 3
DECAY_DROP = 0.5
DETAILS = "augmentation and clahe applied, + gaussian filter"
VERSION="7"
...
with open("D:\FACULTATE\FACULTATE\LICENTA\proiect\models\model_v7\Resnet50.yaml", "w") as yaml_file:
   yaml_file.write(model_yaml)

model.save("D:\FACULTATE\FACULTATE\LICENTA\proiect\models\model_v7\Resnet50.h5")
...
with open(results_file_path, mode='a', newline='') as results_file:
    ...
    results_writer.writerow(
        [num_records, current_date, DETAILS, VERSION])