...
for i, image_id in enumerate(tqdm(df_train['id_code'])):
    image = cv2.imread(
        f'D:/FACULTATE/FACULTATE/LICENTA/proiect/data/APTOS/train_images/train_images_clahe_gaussian_crop/{image_id}.png')
...
RLROP_PATIENCE = 3
DECAY_DROP = 0.5
DETAILS = "augmentation and clahe applied,gaussian filter, crop"
VERSION = "11"
