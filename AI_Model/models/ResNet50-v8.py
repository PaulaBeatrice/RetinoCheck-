...
for i, image_id in enumerate(tqdm(df_train['id_code'])):
    image = cv2.imread(
        f'D:/FACULTATE/FACULTATE/LICENTA/proiect/data/APTOS/train_images/train_images_apply_clahe_normalise/{image_id}.png')
...
RLROP_PATIENCE = 3
DECAY_DROP = 0.5
DETAILS = "augmentation and clahe applied, + normalise"
VERSION="8"
